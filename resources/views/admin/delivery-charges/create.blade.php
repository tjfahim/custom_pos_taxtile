    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">
                    <i class="fa fa-plus"></i> Add New Delivery Charge
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.delivery-charges.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="1" class="form-control @error('from_range') is-invalid @enderror" 
                                       id="from_range" name="from_range" value="{{ old('from_range') }}" min="0" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="1" class="form-control @error('to_range') is-invalid @enderror" 
                                       id="to_range" name="to_range" value="{{ old('to_range') }}" min="0" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="1" class="form-control @error('inside_dhaka_price') is-invalid @enderror" 
                                       id="inside_dhaka_price" name="inside_dhaka_price" value="{{ old('inside_dhaka_price') }}" min="0" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="1" class="form-control @error('outside_dhaka_price') is-invalid @enderror" 
                                       id="outside_dhaka_price" name="outside_dhaka_price" value="{{ old('outside_dhaka_price') }}" min="0" required>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">
                            <i class="fa fa-save"></i> Save Delivery Charge
                        </button>
